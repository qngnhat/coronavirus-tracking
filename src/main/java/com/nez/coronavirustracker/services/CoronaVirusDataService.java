package com.nez.coronavirustracker.services;
...
import com.nez.coronavirustracker.models.LocationStats;
...
public class CoronaVirusDataService {
	...
	public void fetchVirusData() throws IOException, InterruptedException {
		...
		for (CSVRecord record : records) {
			...
			int lastedCases = Integer.parseInt(record.get(record.size() - 1));
			int prevDayCases = Integer.parseInt(record.get(record.size() - 2));
			locationStats.setLatestTotalCases(lastedCases);
			locationStats.setDiffFromPrevDay(lastedCases - prevDayCases);
